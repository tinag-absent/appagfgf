...
(async function() {
  ...
  const urlParams = new URLSearchParams(window.__getHashSearch ? window.__getHashSearch() : window.location.search);
  ...
  const currentUser = safeStorage.getJSON('kaishoku_current_user', null);
