...
(async function() {
  const escapeHtml = window.escapeHtml || (t => String(t == null ? '' : t));
  ...
  async function renderMissions() {
    ...
    container.innerHTML = sorted.map(mission => {
      return `
        <div class="mission-card ${mission.status}" onclick="Router.navigate('#/mission-detail?id=${escapeHtml(mission.id)}')">
          <div class="mission-header">
            <div>
              <div class="mission-title">${escapeHtml(mission.title)}</div>
              <div class="mission-code">${escapeHtml(mission.id)}</div>
            </div>
          ...
          <div class="mission-info">
            <div class="info-item">
              ...
              <div class="info-value">${escapeHtml(mission.location)}</div>
            </div>
            <div class="info-item">
            ...
            <div class="info-item">
              ...
              <div class="info-value" style="color: var(--primary);">${escapeHtml(mission.gsi)}%</div>
            </div>
            <div class="info-item">
              <div class="info-label">実体</div>
              <div class="info-value">${escapeHtml(mission.entity)}</div>
            </div>
            <div class="info-item">
