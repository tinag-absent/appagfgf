...
(async function() {
  ...
  function renderEntities(filter = 'all') {
    ...
    catalog.innerHTML = filtered.map(entity => {
      return `
        <div class="catalog-item" onclick="Router.navigate('#/entity-detail?id=${escapeHtml(entity.id)}')">
          ...
          <div class="catalog-item-content">
            ...
            <div class="stat-row">
              ...
              <span style="color: var(--destructive); font-family: 'JetBrains Mono', monospace; font-weight: 600;">${escapeHtml(entity.threat)}</span>
            </div>
            <div class="stat-row">
